...
// Following People
$sql4 = "SELECT following_user_id FROM fm_followers WHERE user_id = '$userid'";
...
$follow_profile = $conn->query($sql3);

while($row = $follow_profile->fetch_row()) {
    $follow_me[] = $row[0];
}
                ...
                <div class="tab-content following">
                    <div class="tab-pane active" id="follows" role="tabpanel">
                        <?php while($row1 = $result->fetch_assoc()){
                            if (in_array($row1['user_id'], $follow_me)) {
                        ?>
                        <div class="row">
